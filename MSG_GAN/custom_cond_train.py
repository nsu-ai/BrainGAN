...
def parse_arguments():
    ...
    parser.add_argument("--loss_function", action="store", type=str,
                        default="custom-hinge",
                        help="loss function to be used: 'hinge', 'relativistic-hinge', 'custom-hinge', 'wgan-gp")
...
def main(args):
    ...
    :return: None
    """
    from MSG_GAN.GAN import MSG_GAN, Custom_MSG_GAN
    from data_processing.DataLoader import FlatDirectoryImageDataset, \
        get_transform, get_data_loader, FoldersDistributedDataset
    from MSG_GAN.Losses import HingeGAN, RelativisticAverageHingeGAN, CustomHingeGAN, \
        StandardGAN, LSGAN, WGAN_GP
    ...
    msg_gan = Custom_MSG_GAN(depth=args.depth,
